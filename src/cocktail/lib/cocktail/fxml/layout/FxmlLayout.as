...
package cocktail.lib.cocktail.fxml.layout 
{
	import cocktail.lib.cocktail.fxml.Fxml;		

	/**
	 * Fxml base class for layout DOM.
	 * @author nybras | nybras@codeine.it
	 */
	public class FxmlLayout extends Fxml 
	{
		/* ---------------------------------------------------------------------
			INITIALIZING
		--------------------------------------------------------------------- */
		...
		public function action ( name : String ) : XML
		{
			...
			structure = _preprocessor.sweeps ( structure, path );
			structure = _preprocessor.binds ( structure, path );
